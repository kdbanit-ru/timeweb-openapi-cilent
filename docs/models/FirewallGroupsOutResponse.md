# openapi_client.model.firewall_groups_out_response.FirewallGroupsOutResponse
...
**[groups](#groups)** | list, tuple,  | tuple,  | Массив объектов Групп правил | 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Массив объектов Групп правил | 

### Tuple Items
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[**FirewallGroupOutAPI**](FirewallGroupOutAPI.md) | [**FirewallGroupOutAPI**](FirewallGroupOutAPI.md) | [**FirewallGroupOutAPI**](FirewallGroupOutAPI.md) |  | 
