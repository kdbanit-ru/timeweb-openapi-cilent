# openapi_client.model.nodes_response.NodesResponse
...
------------ | ------------- | ------------- | ------------- | -------------
**[nodes](#nodes)** | list, tuple,  | tuple,  | Массив объектов Нода | 
...
Input Type | Accessed Type | Description | Notes
------------ | ------------- | ------------- | -------------
list, tuple,  | tuple,  | Массив объектов Нода | 

### Tuple Items
Class Name | Input Type | Accessed Type | Description | Notes
------------- | ------------- | ------------- | ------------- | -------------
[**NodeOut**](NodeOut.md) | [**NodeOut**](NodeOut.md) | [**NodeOut**](NodeOut.md) |  | 
