...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["buckets", "meta", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["buckets", "meta", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_storages_oapg(
        self,
...
class GetProjectStorages(BaseApi):
    ...
    def get_project_storages(
        ...
        return self._get_project_storages_oapg(
