...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["hash", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["hash", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_database_cluster_oapg(
        self,
...
class DeleteDatabaseCluster(BaseApi):
    ...
    def delete_database_cluster(
        ...
        return self._delete_database_cluster_oapg(
