...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "type", "preset_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "type", "preset_id", ], str]):
...
class CreateStorage(BaseApi):
    ...
    def create_storage(
        ...
        return self._create_storage_oapg(
            body=body,
