...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'resource_type': typing.Union[ResourceTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
    },
    total=False
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_resource_to_group_oapg(
        self,
...
class AddResourceToGroup(BaseApi):
    ...
    def add_resource_to_group(
        ...
        return self._add_resource_to_group_oapg(
