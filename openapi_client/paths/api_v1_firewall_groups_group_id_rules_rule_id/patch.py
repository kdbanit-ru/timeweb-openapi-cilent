...
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        ...
        'rule_id': typing.Union[RuleIdSchema, str, ],
    }
)
...
# body param
SchemaForRequestBodyApplicationJson = FirewallRuleInAPI


request_body_firewall_rule_in_api = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_group_rule_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_firewall_rule_in_api.serialize(body, content_type)
...
class UpdateGroupRule(BaseApi):
    ...
    def update_group_rule(
        ...
        return self._update_group_rule_oapg(
            body=body,
