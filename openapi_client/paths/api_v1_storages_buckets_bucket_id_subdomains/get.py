                ...
                class properties:
                    ...
                    class subdomains(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['S3Subdomain']:
                                return S3Subdomain
                    
                        def __new__(
                            cls,
                            _arg: typing.Union[typing.Tuple['S3Subdomain'], typing.List['S3Subdomain']],
                        ...
                        def __getitem__(self, i: int) -> 'S3Subdomain':
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_storage_subdomains_oapg(
        self,
...
class GetStorageSubdomains(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_storage_subdomains(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_storage_subdomains(
        ...
        return self._get_storage_subdomains_oapg(
