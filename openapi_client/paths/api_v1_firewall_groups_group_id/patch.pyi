...
# body param
SchemaForRequestBodyApplicationJson = FirewallGroupInAPI


request_body_firewall_group_in_api = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _update_group_oapg(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_firewall_group_in_api.serialize(body, content_type)
...
class UpdateGroup(BaseApi):
    ...
    def update_group(
        ...
        return self._update_group_oapg(
            body=body,
