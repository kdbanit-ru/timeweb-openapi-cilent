...
ResourceTypeSchema = ResourceType
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'resource_id': typing.Union[ResourceIdSchema, str, ],
        'resource_type': typing.Union[ResourceTypeSchema, ],
    }
)
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_rules_for_resource_oapg(
        self,
...
class GetRulesForResource(BaseApi):
    ...
    def get_rules_for_resource(
        ...
        return self._get_rules_for_resource_oapg(
