...
IsMultipartSchema = schemas.BoolSchema
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'is_multipart': typing.Union[IsMultipartSchema, bool, ],
    },
    total=False
)
...
request_query_is_multipart = api_client.QueryParameter(
    name="is_multipart",
    style=api_client.ParameterStyle.FORM,
    schema=IsMultipartSchema,
    explode=True,
)
# Path params
...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class all_of_0(
                ...
                class properties:
                    ...
                    class files(
                        ...
                        class MetaOapg:
                            ...
                            @staticmethod
                            def items() -> typing.Type['S3Object']:
                                return S3Object
                    
                        def __new__(
                            cls,
                            _arg: typing.Union[typing.Tuple['S3Object'], typing.List['S3Object']],
                        ...
                        def __getitem__(self, i: int) -> 'S3Object':
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["files", "meta", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["files", "meta", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_storage_files_list_oapg(
        self,
...
class GetStorageFilesList(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_storage_files_list(
        self,
        query_params: RequestQueryParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def get_storage_files_list(
        ...
        return self._get_storage_files_list_oapg(
