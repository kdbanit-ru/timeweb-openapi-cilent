...
class SchemaForRequestBodyApplicationJson(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["destination", "source", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["destination", "source", ], str]):
...
class CopyStorageFile(BaseApi):
    ...
    def copy_storage_file(
        ...
        return self._copy_storage_file_oapg(
            body=body,
