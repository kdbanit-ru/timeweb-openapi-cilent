...
class SchemaFor200ResponseBodyApplicationJson(
    ...
    class MetaOapg:
        ...
        class all_of_0(
            ...
            def __getitem__(self, name: typing.Union[typing_extensions.Literal["databases", "meta", ], str]):
            ...
            def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["databases", "meta", ], str]):
...
class BaseApi(api_client.Api):
    @typing.overload
    def _get_project_databases_oapg(
        self,
...
class GetProjectDatabases(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def get_project_databases(
        self,
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
        stream: bool = False,
    ...
    def get_project_databases(
        ...
        return self._get_project_databases_oapg(
