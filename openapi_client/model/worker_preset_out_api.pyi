...
class WorkerPresetOutApi(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "description", "description_short", "price", "cpu", "ram", "disk", "network", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "description", "description_short", "price", "cpu", "ram", "disk", "network", "type", ], str]):
