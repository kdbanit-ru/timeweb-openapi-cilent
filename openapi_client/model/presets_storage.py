...
class PresetsStorage(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "description", "description_short", "disk", "price", "location", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "description", "description_short", "disk", "price", "location", ], str]):
