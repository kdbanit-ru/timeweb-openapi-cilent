...
class VpcPort(
    ...
    ipv4: MetaOapg.properties.ipv4
    service: MetaOapg.properties.service
    id: MetaOapg.properties.id
    nat_mode: MetaOapg.properties.nat_mode
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "nat_mode", "mac", "ipv4", "service", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["nat_mode"]) -> MetaOapg.properties.nat_mode: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["mac"]) -> MetaOapg.properties.mac: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ipv4"]) -> MetaOapg.properties.ipv4: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "nat_mode", "mac", "ipv4", "service", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ipv4: typing.Union[MetaOapg.properties.ipv4, str, ],
        service: typing.Union[MetaOapg.properties.service, dict, frozendict.frozendict, ],
        id: typing.Union[MetaOapg.properties.id, str, ],
        nat_mode: typing.Union[MetaOapg.properties.nat_mode, str, ],
