...
class ImageUrlAuth(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["access_token", "refresh_token", "expiry", "token_type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["access_token", "refresh_token", "expiry", "token_type", ], str]):
