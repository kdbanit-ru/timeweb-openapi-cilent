...
class MasterPresetOutApi(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "description", "description_short", "price", "cpu", "ram", "disk", "network", "type", "limit", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "description", "description_short", "price", "cpu", "ram", "disk", "network", "type", "limit", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        disk: typing.Union[MetaOapg.properties.disk, decimal.Decimal, int, ],
        price: typing.Union[MetaOapg.properties.price, decimal.Decimal, int, float, ],
        cpu: typing.Union[MetaOapg.properties.cpu, decimal.Decimal, int, ],
        description: typing.Union[MetaOapg.properties.description, str, ],
        id: typing.Union[MetaOapg.properties.id, decimal.Decimal, int, ],
        network: typing.Union[MetaOapg.properties.network, decimal.Decimal, int, ],
