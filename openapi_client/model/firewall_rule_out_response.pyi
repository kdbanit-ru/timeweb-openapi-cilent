...
class FirewallRuleOutResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["rule", "response_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["rule", "response_id", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        rule: typing.Union[MetaOapg.properties.rule, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
