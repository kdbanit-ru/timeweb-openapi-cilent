...
class ImageDownloadAPI(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "created_at", "image", "type", "status", "progress", "url", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "created_at", "image", "type", "status", "progress", "url", ], str]):
