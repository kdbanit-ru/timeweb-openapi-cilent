...
class CreateDb(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["password", "name", "type", "preset_id", "login", "hash_type", "config_parameters", "network", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["password", "name", "type", "preset_id", "login", "hash_type", "config_parameters", "network", ], str]):
