...
class Network(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "ip", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "ip", ], str]):
