...
class NodeGroupIn(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "preset_id", "node_count", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "preset_id", "node_count", ], str]):
