...
class CreatedApiKey(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["token", "id", "created_at", "name", "expired_at", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["token", "id", "created_at", "name", "expired_at", ], str]):
