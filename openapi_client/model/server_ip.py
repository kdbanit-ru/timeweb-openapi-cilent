...
class ServerIp(
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["ptr"]) -> MetaOapg.properties.ptr: ...
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ptr: typing.Union[MetaOapg.properties.ptr, str, ],
