...
class Quota(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["total", "used", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["total", "used", ], str]):
