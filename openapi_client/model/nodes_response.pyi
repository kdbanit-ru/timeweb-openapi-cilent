...
class NodesResponse(
        ...
        class properties:
            ...
            class nodes(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['NodeOut']:
                        return NodeOut
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['NodeOut'], typing.List['NodeOut']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'nodes':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'NodeOut':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meta", "nodes", "response_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meta", "nodes", "response_id", ], str]):
