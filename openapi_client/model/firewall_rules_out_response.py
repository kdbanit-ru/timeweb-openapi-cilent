...
class FirewallRulesOutResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class rules(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FirewallRuleOutAPI']:
                        return FirewallRuleOutAPI
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['FirewallRuleOutAPI'], typing.List['FirewallRuleOutAPI']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'rules':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'FirewallRuleOutAPI':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meta", "rules", "response_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meta", "rules", "response_id", ], str]):
