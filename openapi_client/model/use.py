...
class Use(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["money_source", "person_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["money_source", "person_id", ], str]):
