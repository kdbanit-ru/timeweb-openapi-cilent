...
class ImageOutAPI(
    ...
    disk_id: MetaOapg.properties.disk_id
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "status", "created_at", "deleted_at", "size", "name", "description", "disk_id", "os", "progress", "is_custom", "location", ], str]):
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["disk_id"]) -> MetaOapg.properties.disk_id: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "status", "created_at", "deleted_at", "size", "name", "description", "disk_id", "os", "progress", "is_custom", "location", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        os: typing.Union[MetaOapg.properties.os, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, bool, None, list, tuple, bytes, io.FileIO, io.BufferedReader, ],
        ...
        deleted_at: typing.Union[MetaOapg.properties.deleted_at, str, datetime, ],
        disk_id: typing.Union[MetaOapg.properties.disk_id, decimal.Decimal, int, ],
