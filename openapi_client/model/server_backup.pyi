...
class ServerBackup(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "comment", "created_at", "status", "size", "type", "progress", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "comment", "created_at", "status", "size", "type", "progress", ], str]):
