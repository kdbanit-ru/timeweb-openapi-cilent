...
class BucketUser(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "access_key", "secret_key", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "access_key", "secret_key", ], str]):
