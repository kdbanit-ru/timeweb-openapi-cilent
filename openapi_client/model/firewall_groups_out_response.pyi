...
class FirewallGroupsOutResponse(
    schemas.DictSchema
):
        ...
        class properties:
            ...
            class groups(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['FirewallGroupOutAPI']:
                        return FirewallGroupOutAPI
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['FirewallGroupOutAPI'], typing.List['FirewallGroupOutAPI']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'groups':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'FirewallGroupOutAPI':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meta", "groups", "response_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meta", "groups", "response_id", ], str]):
