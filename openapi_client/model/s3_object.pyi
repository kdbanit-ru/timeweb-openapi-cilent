...
class S3Object(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            storage_class = schemas.StrSchema
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["storage_class"]) -> MetaOapg.properties.storage_class: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "key", "last_modified", "etag", "size", "storage_class", "checksum_algorithm", "owner", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["storage_class"]) -> typing.Union[MetaOapg.properties.storage_class, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["checksum_algorithm"]) -> typing.Union[MetaOapg.properties.checksum_algorithm, schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "key", "last_modified", "etag", "size", "storage_class", "checksum_algorithm", "owner", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        storage_class: typing.Union[MetaOapg.properties.storage_class, str, schemas.Unset] = schemas.unset,
        checksum_algorithm: typing.Union[MetaOapg.properties.checksum_algorithm, list, tuple, schemas.Unset] = schemas.unset,
