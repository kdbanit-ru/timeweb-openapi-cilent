...
class SchemasBaseError(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["status_code", "error_code", "message", "response_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["status_code", "error_code", "message", "response_id", ], str]):
