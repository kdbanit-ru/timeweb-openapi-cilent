...
class DomainRegister(
            ...
            class ns(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["host", "ips", ], str]):
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["host", "ips", ], str]):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["action", "fqdn", "person_id", "is_autoprolong_enabled", "is_whois_privacy_enabled", "ns", "period", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["action", "fqdn", "person_id", "is_autoprolong_enabled", "is_whois_privacy_enabled", "ns", "period", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        ns: typing.Union[MetaOapg.properties.ns, list, tuple, schemas.Unset] = schemas.unset,
