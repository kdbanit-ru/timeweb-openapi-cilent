...
class Project(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "account_id", "avatar_id", "description", "name", "is_default", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "account_id", "avatar_id", "description", "name", "is_default", ], str]):
