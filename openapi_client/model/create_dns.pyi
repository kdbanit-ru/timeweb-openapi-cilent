...
class CreateDns(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["type", "value", "priority", "subdomain", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["type", "value", "priority", "subdomain", ], str]):
