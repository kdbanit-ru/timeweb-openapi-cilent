...
class AddedSubdomain(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["subdomain", "status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["subdomain", "status", ], str]):
