...
class ImagesOutResponse(
        ...
        class properties:
            ...
            class images(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ImageOutAPI']:
                        return ImageOutAPI
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ImageOutAPI'], typing.List['ImageOutAPI']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'images':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ImageOutAPI':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meta", "images", "response_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meta", "images", "response_id", ], str]):
