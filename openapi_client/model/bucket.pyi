...
class Bucket(
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            class status(
                ...
                def TRANSFER(cls):
                    return cls("transfer")
            object_amount = schemas.NumberSchema
    ...
    object_amount: MetaOapg.properties.object_amount
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["object_amount"]) -> MetaOapg.properties.object_amount: ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "disk_stats", "type", "preset_id", "status", "object_amount", "location", "hostname", "access_key", "secret_key", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["object_amount"]) -> MetaOapg.properties.object_amount: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "disk_stats", "type", "preset_id", "status", "object_amount", "location", "hostname", "access_key", "secret_key", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        disk_stats: typing.Union[MetaOapg.properties.disk_stats, dict, frozendict.frozendict, ],
        ...
        object_amount: typing.Union[MetaOapg.properties.object_amount, decimal.Decimal, int, float, ],
