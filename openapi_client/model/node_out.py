...
class NodeOut(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "created_at", "type", "group_id", "status", "preset_id", "cpu", "ram", "disk", "network", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "created_at", "type", "group_id", "status", "preset_id", "cpu", "ram", "disk", "network", ], str]):
