...
class ClustersResponse(
        ...
        class properties:
            ...
            class clusters(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ClusterOut']:
                        return ClusterOut
            
                def __new__(
                    cls,
                    _arg: typing.Union[typing.Tuple['ClusterOut'], typing.List['ClusterOut']],
                    _configuration: typing.Optional[schemas.Configuration] = None,
                ) -> 'clusters':
                    return super().__new__(
                        cls,
                ...
                def __getitem__(self, i: int) -> 'ClusterOut':
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["meta", "clusters", "response_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["meta", "clusters", "response_id", ], str]):
