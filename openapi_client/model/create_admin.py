...
class CreateAdmin(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["login", "password", "privileges", "host", "instance_id", "description", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["login", "password", "privileges", "host", "instance_id", "description", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        ...
        instance_id: typing.Union[MetaOapg.properties.instance_id, decimal.Decimal, int, float, schemas.Unset] = schemas.unset,
