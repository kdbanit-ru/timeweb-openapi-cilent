...
class ProjectResource(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "created_at", "resource_id", "project", "type", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "created_at", "resource_id", "project", "type", ], str]):
