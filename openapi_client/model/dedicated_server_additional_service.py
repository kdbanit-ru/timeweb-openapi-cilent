...
class DedicatedServerAdditionalService(
    schemas.DictSchema
):
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "price", "period", "description", "short_description", "name", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "price", "period", "description", "short_description", "name", ], str]):
