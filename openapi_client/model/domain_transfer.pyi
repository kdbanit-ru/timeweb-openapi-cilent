...
class DomainTransfer(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["action", "auth_code", "fqdn", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["action", "auth_code", "fqdn", ], str]):
